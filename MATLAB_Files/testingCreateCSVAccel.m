...
fingerOrder  = ["p","r","m","i"];
data = importfile("RecordedDataAccel-" + "test" +  ".csv",[1,inf]);
x = data.x(15:end-15);
y = data.y(15:end-15);
z = data.z(15:end-15);
...
[zTimeIndex,zData,sampleZ]= getTaps(filteredDataZ, averageFilteredZ, 28, time, 1.8, "_accel_z", fingerOrder);                
...
% Create final Model
Final_Model_Accel_TESTING16 = [sampleX(:,1:end), sampleY(:,1:end), sampleZ(:, 1:end)];
Final_Model_Accel_TESTING16
...
save(fileName , 'Final_Model_Accel_TESTING16')
