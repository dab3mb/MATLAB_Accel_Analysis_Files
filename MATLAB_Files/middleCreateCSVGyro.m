...
[xTimeIndex,xData,sampleX]= getTaps(filteredDataX, averageFilteredX, 28, time, 1.6, "_gyro_x", whichFinger);                
...
% Create final Model
Final_Model_GYRO_MIDDLE30 = [sampleZ(:,1:end), sampleY(:,1:end), sampleX(:, 1:end)];
Final_Model_GYRO_MIDDLE30
...
save(fileName , 'Final_Model_GYRO_MIDDLE30')
