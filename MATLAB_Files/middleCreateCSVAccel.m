...
[zTimeIndex,zData,sampleZ]= getTaps(filteredDataZ, averageFilteredZ, 28, time, 1.25, "_accel_z", whichFinger);                
...
% Create final Model
Final_Model_Accel_MIDDLE30 = [sampleX(:,1:end), sampleY(:,1:end), sampleZ(:, 1:end)];
Final_Model_Accel_MIDDLE30
...
save(fileName , 'Final_Model_Accel_MIDDLE30')
